...
def update_data_to_db(period="daily"):
    ...
    BASE_DIR = os.path.dirname(os.path.abspath(__file__))  # ✅ benar # direktori file .py saat ini
    model_path = os.path.join(BASE_DIR, "pickle_save_parameter_hargabeli", f"model_pred_pp_xgb_{period}.pkl")
