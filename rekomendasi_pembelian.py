...
def main(produk_terpilih, kode_terpilih):
    ...
    if st.button("Hitung Rekomendasi"):
        ...
        hist_oil = model_oil["historical_data"].copy(deep=True)
        hist_pp = model_pp["historical_data"].copy(deep=True)
        ...
        if os.path.exists(harga_daily_path):
            ...
            hist_oil_daily = model_oil_daily["historical_data"].copy(deep=True)
            hist_pp_daily = model_pp_daily["historical_data"].copy(deep=True)
